...
export async function GET(
  ...
  if (message.has_answered) {
    ...
    return streamResponse(transformStream, 403);
  }
  ...
  return streamResponse(transformStream);
}

function streamResponse(responseStream: TransformStream, status: number = 200) {
